Terminal_Duel is a simple Python program that runs a terminal-based game. It allows you to create a character and choose a class, with the core gameplay revolving around turn-based combat.
